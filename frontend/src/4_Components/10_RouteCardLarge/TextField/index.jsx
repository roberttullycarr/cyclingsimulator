...
const text = `carr, je bent in staat om de Mont Ventoux starting from Bedoin (21,5 km) te beklimmen in 83 minuten.
...
const bottomText = `Mee te nemen tijdens de beklimming: #WERT! 0,3 sneetjes peperkoek ofwel 0,3 energie-gels. Check zeker eens op voorhand de verpakking.`
